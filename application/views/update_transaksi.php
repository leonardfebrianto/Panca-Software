	...
	<div class="col-lg-12">
		<div class="col-lg-12">
			<div class="box box-primary">
				...
				<?php foreach($data as $value){ $kode_transaksi = $value->kode_transaksi;?>
					<form class="form-horizontal" method="post" action="<?php echo site_url('welcome/doupdate_transaksi/' . $kode_transaksi);?>">
					<div class="col-lg-6">
						<h4>Penjualan</h4>
					</div>
					<div class="col-lg-6 text-right">
						<button type="submit" class="btn btn-danger">Simpan <i class="fa fa-arrow-circle-right" style="margin-left:10px;"></i></button> 
					</div>
				</div>
				<div class="box-body">
						<div class="col-lg-6 form-group">
							...
							<div class="col-lg-9">
								<input type="date" name="tanggal"  value="<?php echo $value->tanggal;?>" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
							<label class="col-lg-3">Pelanggan</label>
							<div class="col-lg-9">
								<select name="pelanggan" id="pelanggan" class="col-lg-12 form-control">
									<option value="" selected disabled>--Pilih Pelanggan--</option>
							<?php foreach($data2 as $value2){ ?>
									<option value="<?php echo $value2->kode_pelanggan;?>" <?php if($value2->kode_pelanggan == $value->kode_pelanggan) echo "selected"?>><?php echo $value2->toko_pelanggan;?></option>
							<?php } ?>
								</select>
							</div>
							<br /><br /><br />
						...
						<div class="col-lg-6">
							...
							<div class="col-lg-9">
								<input type="text" name="nota" value="<?php echo $value->nota_transaksi;?>" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
							<label class="col-lg-3">Diskon</label>
							<div class="col-lg-9">
								<input type="text" name="diskon" value="<?php echo $value->diskon;?>" class="col-lg-12 form-control" />
							</div>
						</div><?php }?>
						<div class="col-lg-12">
							...
							<table id="tablejobfile" class="table table-bordered table-striped col-md-12">
								...
								<tbody id="tbody">
									...
									<tr>
										...
										<td><?php $total_modal = $value->harga_modal * $value->quantity; echo $total_modal;?></td>
										<td><?php $total_jual = $value->harga_jual * $value->quantity; echo $total_jual;?></td>
										<td><?php echo $value->total_profit;?></td>
										<td><a href="<?php echo site_url()?>/welcome/delete_transaksi_child/<?php echo $value->id;?>" ><i style="color:red;" class="glyphicon glyphicon-remove"></i></a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
...
<div class="modal fade" id="modal-default">
  	<div class="modal-dialog">
    	<form method="post" action="<?php echo site_url('welcome/save_transaksi_child/' . $kode_transaksi);?>">
