	...
	<div class="col-lg-12">
		<div class="col-lg-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form class="form-horizontal" method="post" action="<?php echo site_url('welcome/save_pelanggan');?>">
						<div class="col-lg-6 form-group">
							<label class="col-lg-3">Nama Toko</label>
							<div class="col-lg-9">
								<input type="text" name="toko_pelanggan" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
							<label class="col-lg-3">Nama PIC</label>
							<div class="col-lg-9">
								<input type="text" name="pic_pelanggan" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
						</div>
						<div class="col-lg-6">
							...
							<div class="col-lg-9">
								<input type="text" name="alamat_pelanggan" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
							<label class="col-lg-3">No. Telp</label>
							<div class="col-lg-9">
								<input type="number" name="telp_pelanggan" class="col-lg-12 form-control" />
							</div>
							<br /><br /><br />
							<div class="col-lg-8">
							</div>
